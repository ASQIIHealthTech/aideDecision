...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function savePatient() {
        ...
        if (document.getElementById("div-err")) {
            document.getElementById("div-err").parentNode.removeChild(document.getElementById("div-err"));
        }
        ...
        fetch(save_patient_url, {
            ...
            var first_text = document.createTextNode("An Error Occured Saving The Patient!!");
